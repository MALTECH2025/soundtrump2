        ...
        <section className="flex-grow pt-24 pb-12 px-4">
          <div className="container mx-auto text-center">
            <motion.div
              ...
              className="mb-8"
            >
              <Badge variant="secondary" className="mb-4 bg-gradient-to-r from-primary to-accent text-primary-foreground border-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button 
                  ...
                  className="bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 text-primary-foreground font-semibold px-8 py-3 rounded-full"
                >
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <motion.div
                ...
                transition={{ duration: 0.6, delay: 0.2 }}
              >
                <Card className="bg-gradient-to-br from-accent/10 to-accent/5 border-accent/20 hover:border-accent/40 transition-all duration-300">
                  <CardHeader>
